...

{
  ...
  lVar8 = BfsLookupPolicyEntryHashTable(uVar12,local_c8,param_5,param_6);
  lVar11 = local_d0;
  if (lVar8 == 0) {
    ...
    if ((lVar9 == 0) ||
       ...
       lVar10 == 0)) goto LAB_000068ef;
    uVar12 = (ulonglong)((uint)*(byte *)(lVar11 + 1) * 4 + 8);
    uVar7 = RtlCopySid(uVar12,lVar9,lVar11);
    if ((int)uVar7 < 0) {
LAB_00006981:
      if (3 < DAT_00016000) {
...
LAB_00006907:
      ...
      uVar12 = (ulonglong)((uint)*(byte *)(param_6 + 1) * 4 + 8);
      uVar7 = RtlCopySid(uVar12,lVar10,param_6);
      if ((int)uVar7 < 0) goto LAB_00006981;
        ...
        *(longlong *)(lVar8 + 0x28) = lVar11;
        if (lVar11 != 0) {
          *(longlong *)(lVar8 + 0x18) = lVar9;
          uVar12 = Feature_3148938554__private_IsEnabledDeviceUsageNoInline();
          ...
          *(undefined8 *)(lVar8 + 0x88) = 0;
          KeInitializeEvent(*(undefined8 *)(lVar8 + 0x28),0,0);
          uVar12 = *(ulonglong *)(param_3 + 8);
          uVar7 = BfsInsertEntryHashTable(uVar12,local_c8,lVar8);
          if (-1 < (int)uVar7) {
            LOCK();
            *(int *)(lVar8 + 0x90) = *(int *)(lVar8 + 0x90) + 1;
            UNLOCK();
            ...
            if ((longlong *)*puVar2 != plVar1) goto LAB_00006de1;
...
LAB_00006c76:
      ...
      if (local_d8 != '\0') {
        ...
        lVar11 = BfsLookupPolicyEntryHashTable
                           (*(undefined8 *)(param_3 + 8),local_c8,local_d0,param_6);
        if (lVar11 == 0) {
          ExReleasePushLockExclusiveEx(param_3,0);
          KeLeaveCriticalRegion();
        }
        else {
          plVar1 = (longlong *)(lVar11 + 0x40);
          *(undefined4 *)(lVar11 + 0x38) = 1;
          lVar8 = *plVar1;
          if ((*(longlong **)(lVar8 + 8) != plVar1) ||
             (plVar3 = *(longlong **)(lVar11 + 0x48), (longlong *)*plVar3 != plVar1)) {
LAB_00006de1:
          ...
          *(longlong **)(lVar8 + 8) = plVar3;
          ...
          BfsDereferencePolicyEntryEx(lVar11,'\0');
        }
      }
      if (bVar5) {
...
LAB_00006af0:
      ...
      if (-1 < (int)uVar7) {
        bVar5 = true;
        pdVar14 = (dword *)&local_98;
        uVar7 = RtlConvertSidToUnicodeString(pdVar14,param_6,1);
        if (-1 < (int)uVar7) {
          bVar6 = true;
          pdVar14 = local_b8;
          uVar7 = BfsOpenPolicyDirectory(local_b8,local_e0,local_a8,'\0',&local_c0);
          if ((-1 < (int)uVar7) &&
             (pdVar14 = local_b8,
             uVar7 = BfsCreateStorage(local_b8,local_e0,local_c0,&local_98,&local_b0),
             -1 < (int)uVar7)) {
            RtlFreeUnicodeString(local_a8);
            RtlFreeUnicodeString(&local_98);
            KeEnterCriticalRegion();
